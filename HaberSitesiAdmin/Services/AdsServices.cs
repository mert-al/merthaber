...
namespace HaberSitesiAdmin.Services
{
    public class AdsServices
    {
        ...
        public void GenerateXML(Ad reklam)
        {
            ...
            var newFileName = string.Format(reklam.PostrollTitle,".xml");
        ...
        public void GenerateXMLL(Ad reklam)
        {
            XmlDocument doc = new XmlDocument();
            XmlNode xmlNode = doc.CreateXmlDeclaration("1.0", null, null);
            doc.AppendChild(xmlNode);
            ...
            XmlCDataSection CData1 = doc.CreateCDataSection(reklam.Midroll);
            MediaFile.AppendChild(CData1);
            ...
            var newFileName = string.Format("MidrollTitle", ".xml");
            doc.Save(basepath + newFileName);
        ...
        public void GenerateXMLLL(Ad reklam)
        {
            XmlDocument doc = new XmlDocument();
            XmlNode xmlNode = doc.CreateXmlDeclaration("1.0", null, null);
            doc.AppendChild(xmlNode);
            ...
            XmlCDataSection CData1 = doc.CreateCDataSection(reklam.Postroll);
            MediaFile.AppendChild(CData1);
            ...
            var newFileName = string.Format("PostrollTitle",".xml");
            doc.Save(basepath + newFileName);
